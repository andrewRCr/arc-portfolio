...
export function ThemeToggle() {
  ...
  if (!mounted) {
    ...
    return (
      <Button
        ...
        // will-change-transform: prevents Safari button jitter during theme transitions
        // See: strategy-safari-transition-accommodations.md
  ...
  return (
    <Button
      ...
      // will-change-transform: prevents Safari button jitter during theme transitions
      // See: strategy-safari-transition-accommodations.md
      className="border-transparent hover:border-transparent hover:bg-transparent text-muted-foreground hover:text-accent-mid will-change-transform"
    >
