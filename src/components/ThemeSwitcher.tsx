  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="rounded border border-border bg-background px-2 py-1 text-sm text-foreground transition-colors hover:border-secondary/60 focus-visible:border-secondary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
      >
