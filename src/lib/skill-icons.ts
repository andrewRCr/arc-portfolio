 ...
 * Uses build-time extracted icon data (from simple-icons) plus custom icons
 * for technologies not in simple-icons.
 *
 * Icon data is generated by: scripts/generate-skill-icons.ts
 * Only the ~36 icons referenced in skills.ts are included (not all 3,300+).
 */

import { SIMPLE_ICON_DATA } from "@/data/generated/skill-icon-data";
...
/** Combined lookup: generated simple-icons data + custom icons */
const allIcons: Record<string, SkillIconData> = {
  ...SIMPLE_ICON_DATA,
  ...customIcons,
};
