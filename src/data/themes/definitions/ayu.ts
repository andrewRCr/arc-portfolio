...
const darkTokens: ThemeColors = {
  ...
  // Secondary colors (cyan - toned down for UI backgrounds)
  // Using softened tag instead of bright tag for less electric/neon appearance
  secondary: hexToRgb(ayuA11y.tagSoftened), // #52AFC6
