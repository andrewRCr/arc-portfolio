...
function ProjectsContent() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6">
      ...
      {/* Tab Panels */}
      {currentTab === "software" && (
        <div id="panel-software" role="tabpanel" aria-labelledby="tab-software" tabIndex={0} className="space-y-6 py-4">
        ...
        <div id="panel-mods" role="tabpanel" aria-labelledby="tab-mods" tabIndex={0} className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              ...
              maintenance. With ~35 published mods and thousands of downloads, this work reflects the same professional
              approach I bring to software development: thorough documentation, responsive support, and continuous
              improvement.
            </p>
          </div>
